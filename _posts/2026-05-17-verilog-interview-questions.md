...
- **[FSM Design in Verilog]({{ '/blog/2026/05/17/fsm-design-verilog/' | relative_url }})** — master the FSM interview questions with real code
- **[SystemVerilog vs Verilog]({{ '/blog/2026/05/17/systemverilog-vs-verilog/' | relative_url }})** — answer the SV-specific questions confidently
- **[Setup & Hold Time — STA]({{ '/blog/2026/05/17/setup-hold-time-sta/' | relative_url }})** — deep dive into timing interview questions
