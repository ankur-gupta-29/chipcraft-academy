...
<ol class="lp-steps">
  <li class="lp-step">
    ...
    <div class="lp-step-body">
      <h4><a href="{% post_url 2026-05-01-what-is-digital-ic-design %}">What Is Digital IC Design?</a> <span class="lp-badge beginner">Beginner</span></h4>
  ...
  <li class="lp-step">
    ...
    <div class="lp-step-body">
      <h4><a href="{% post_url 2026-05-08-asic-vs-fpga %}">ASIC vs FPGA — Which Should You Learn?</a> <span class="lp-badge beginner">Beginner</span></h4>
  ...
  <li class="lp-step">
    ...
    <div class="lp-step-body">
      <h4><a href="{% post_url 2026-05-10-how-to-start-rtl-design %}">How to Start RTL Design</a> <span class="lp-badge beginner">Beginner</span></h4>
  ...
  <li class="lp-step">
    ...
    <div class="lp-step-body">
      <h4><a href="{% post_url 2026-05-05-best-free-verilog-courses-2026 %}">Best Free Verilog Courses (2026)</a> <span class="lp-badge beginner">Beginner</span></h4>
  ...
  <li class="lp-step">
    ...
    <div class="lp-step-body">
      <h4><a href="{% post_url 2026-05-12-top-5-books-vlsi-beginners %}">Top 5 Books for VLSI Beginners</a> <span class="lp-badge beginner">Beginner</span></h4>
...
<ol class="lp-steps">
  <li class="lp-step">
    <div class="lp-step-num">1</div>
    <div class="lp-step-body">
      <h4><a href="{% post_url 2026-05-17-systemverilog-vs-verilog %}">SystemVerilog vs Verilog — Key Differences</a> <span class="lp-badge beginner">Beginner</span></h4>
  ...
  <li class="lp-step">
    <div class="lp-step-num">2</div>
    <div class="lp-step-body">
      <h4><a href="{% post_url 2026-05-17-fsm-design-verilog %}">FSM Design in Verilog — Moore, Mealy & Best Practices</a> <span class="lp-badge intermediate">Intermediate</span></h4>
  ...
  <li class="lp-step">
    <div class="lp-step-num">3</div>
    <div class="lp-step-body">
      <h4><a href="{% post_url 2026-05-17-pipeline-rtl-design %}">RTL Pipelining — Design & Hazard Handling</a> <span class="lp-badge intermediate">Intermediate</span></h4>
  ...
  <li class="lp-step">
    <div class="lp-step-num">4</div>
    <div class="lp-step-body">
      <h4><a href="{% post_url 2026-05-12-riscv-single-cycle-verilog %}">RISC-V Single-Cycle CPU in Verilog</a> <span class="lp-badge advanced">Advanced</span></h4>
  ...
  <li class="lp-step">
    <div class="lp-step-num">5</div>
    <div class="lp-step-body">
      <h4><a href="{% post_url 2026-05-17-verilog-interview-questions %}">50 Verilog & Digital Design Interview Questions</a> <span class="lp-badge intermediate">Intermediate</span></h4>
...
<ol class="lp-steps">
  <li class="lp-step">
    <div class="lp-step-num">1</div>
    <div class="lp-step-body">
      <h4><a href="{% post_url 2026-05-17-setup-hold-time-sta %}">Setup & Hold Time — Static Timing Analysis</a> <span class="lp-badge beginner">Beginner</span></h4>
  ...
  <li class="lp-step">
    <div class="lp-step-num">2</div>
    <div class="lp-step-body">
      <h4><a href="{% post_url 2026-05-17-sdc-timing-constraints %}">SDC Timing Constraints — Complete Guide</a> <span class="lp-badge intermediate">Intermediate</span></h4>
  ...
  <li class="lp-step">
    <div class="lp-step-num">3</div>
    <div class="lp-step-body">
      <h4><a href="{% post_url 2026-05-17-synopsys-design-compiler %}">RTL Synthesis with Synopsys Design Compiler</a> <span class="lp-badge intermediate">Intermediate</span></h4>
  ...
  <li class="lp-step">
    <div class="lp-step-num">4</div>
    <div class="lp-step-body">
      <h4><a href="{% post_url 2026-05-17-vlsi-floorplanning %}">VLSI Floorplanning — Concepts & Techniques</a> <span class="lp-badge intermediate">Intermediate</span></h4>
  ...
  <li class="lp-step">
    <div class="lp-step-num">5</div>
    <div class="lp-step-body">
      <h4><a href="{% post_url 2026-05-17-power-analysis-asic %}">Power Analysis — Dynamic, Static & Low-Power Techniques</a> <span class="lp-badge advanced">Advanced</span></h4>
  ...
  <li class="lp-step">
    ...
    <div class="lp-step-body">
      <h4><a href="{% post_url 2026-05-12-librelane-tutorial-beginners %}">LibreLane ASIC Flow Tutorial</a> <span class="lp-badge intermediate">Intermediate</span></h4>
  ...
  <li class="lp-step">
    ...
    <div class="lp-step-body">
      <h4><a href="{% post_url 2026-05-13-cadence-virtuoso-innovus-shortcuts %}">Cadence Innovus Keyboard Shortcuts</a> <span class="lp-badge intermediate">Intermediate</span></h4>
...
<ol class="lp-steps">
  <li class="lp-step">
    <div class="lp-step-num">1</div>
    <div class="lp-step-body">
      <h4><a href="{% post_url 2026-05-17-clock-domain-crossing %}">Clock Domain Crossing — CDC Verification</a> <span class="lp-badge intermediate">Intermediate</span></h4>
  ...
  <li class="lp-step">
    <div class="lp-step-num">2</div>
    <div class="lp-step-body">
      <h4><a href="{% post_url 2026-05-13-systemverilog-assertions-sva-guide %}">SystemVerilog Assertions (SVA) — Complete Guide</a> <span class="lp-badge intermediate">Intermediate</span></h4>
  ...
  <li class="lp-step">
    <div class="lp-step-num">3</div>
    <div class="lp-step-body">
      <h4><a href="{% post_url 2026-05-13-functional-coverage-systemverilog %}">Functional Coverage in SystemVerilog</a> <span class="lp-badge intermediate">Intermediate</span></h4>
  ...
  <li class="lp-step">
    <div class="lp-step-num">4</div>
    <div class="lp-step-body">
      <h4><a href="{% post_url 2026-05-13-uvm-testbench-from-scratch %}">UVM Testbench from Scratch</a> <span class="lp-badge advanced">Advanced</span></h4>
  ...
  <li class="lp-step">
    <div class="lp-step-num">5</div>
    <div class="lp-step-body">
      <h4><a href="{% post_url 2026-05-13-cocotb-python-rtl-verification-tutorial %}">cocotb — Python-Based RTL Verification</a> <span class="lp-badge intermediate">Intermediate</span></h4>
